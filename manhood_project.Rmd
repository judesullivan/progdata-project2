...
Interestingly, participant's country of origin did not emerge as a covariate across my analyses, so I never compared precarious manhood belief ratings between men from Australia, Canada, England, Ireland, and the United States. The present work aims to fill in this gap in my previous research. 
...
2. Investigate Precarious Manhood Belief ratings across countries
...
preman_de <- honorsthesis_analyzing %>% # 1 = strongly disagree; 7 = strongly agree
